...
namespace ToDoList.Tests
{
    public class UserServiceTests
    {
        ...
        {
            // Arrange
            var userCreateDto = new UserCreateDto { Email = "newuser@example.com" };
        ...
        {
            // Arrange
            var userCreateDto = new UserCreateDto { Email = "existinguser@example.com" };
        ...
        public async Task UpdateUserAsync_ShouldReturnTrue_WhenUserUpdated()
        {
            // Arrange
            int userId = 1;
            var userUpdateDto = new UserUpdateDto { Email = "updateduser@example.com" };
